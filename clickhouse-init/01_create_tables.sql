...
INSERT INTO changelog_db.classifier VALUES ('OPT-TECH', 'Технол. оптимизация', 'Технологическая', 'Изменение режима, объединение пробоотборов', 'Ускорение');
INSERT INTO changelog_db.classifier VALUES ('OPT-RES', 'Оптимизация ресурсов', 'Технологическая', 'Добавление персонала, перераспределение', 'Ускорение');
INSERT INTO changelog_db.classifier VALUES ('OPT-SCOPE', 'Оптимизация объёма', 'Технологическая', 'Сокращение экспериментов по решению команды', 'Ускорение');
INSERT INTO changelog_db.classifier VALUES ('DELAY-EXT', 'Внешняя задержка', 'Ресурсная', 'Поставка реагентов, срыв подрядчиком', 'Задержка');
INSERT INTO changelog_db.classifier VALUES ('DELAY-INT', 'Внутренняя задержка', 'Ресурсная', 'Ошибка методики, задержка согласования', 'Задержка');
INSERT INTO changelog_db.classifier VALUES ('DELAY-TECH', 'Технол. препятствие', 'Ресурсная', 'Повторный прогон, отказ оборудования', 'Задержка');
INSERT INTO changelog_db.classifier VALUES ('SCOPE-ADD', 'Расширение объёма', 'Организационная', 'Новые эксперименты, дополнительный раздел ОТР', 'Перепланирование');
INSERT INTO changelog_db.classifier VALUES ('REPLAN', 'Ошибка планирования', 'Организационная', 'Неверная оценка трудоёмкости', 'Перепланирование');
INSERT INTO changelog_db.classifier VALUES ('UNKNOWN', 'Нет данных', '-', 'Текст пустой или бессмысленный', '-');
